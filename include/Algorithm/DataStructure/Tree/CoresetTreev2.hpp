...
#ifndef SESAME_INCLUDE_ALGORITHM_DATASTRUCTURE_TREE_CORESETTREE_HPP_
#define SESAME_INCLUDE_ALGORITHM_DATASTRUCTURE_TREE_CORESETTREE_HPP_
#include <cstdio>
#include <cstdlib>
#include <cstring>
#include <Algorithm/DataStructure/Tree/GeneralTree.hpp>
...
class CoresetTreeNode : public GeneralTreeNode<SESAME::PointPtr>{
  double cost;
};
...
#endif //SESAME_INCLUDE_ALGORITHM_DATASTRUCTURE_TREE_CORESETTREE_HPP_
